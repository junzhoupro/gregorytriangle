...
# us, vs, ws are variables to store (u,v,weights) of the possible 2-fold symmetric points
# funcEvals: evaluation of the possible 2-fold symmetric points
...
def currentResiduals(optVars, exactInts, indsRowCol):
    ...
    return funcEvals6.dot(ws6) + funcEvals3.dot(ws3) + funcEvals1.dot(ws1) - exactInts
...
def computeExactInts(indsRowCol):
	...
	#F = (dGdu[indsRowCol[0, k]] * dGdu[indsRowCol[1, k]]).simplify()
	...
	# dGdu*dGdu (57)
    return np.array([0.300000000000000000000000, 0.000000000000000000000000, -0.0500000000000000000000000, -0.128571428571428571428571, 0.171428571428571428571429, 0.0642857142857142857142857, -0.0357142857142857142857143, -0.0357142857142857142857143, -0.0857142857142857142857143, -0.0428571428571428571428571, -0.0428571428571428571428571, -0.0342857142857142857142857, -0.0228571428571428571428571, -0.0228571428571428571428571, -0.0342857142857142857142857, 0.150000000000000000000000, -0.0571428571428571428571429, -0.00892857142857142857142857, -0.00892857142857142857142857, -0.0410714285714285714285714, 0.0375000000000000000000000, 0.0414285714285714285714286, 0.0442857142857142857142857, 0.0285714285714285714285714, 0.00714285714285714285714286, 0.00142857142857142857142857, 0.0200000000000000000000000, 0.235714285714285714285714, 0.176785714285714285714286, -0.123214285714285714285714, -0.0696428571428571428571429, -0.0328571428571428571428571, -0.0528571428571428571428571, -0.0600000000000000000000000, -0.0471428571428571428571429, -0.0357142857142857142857143, -0.0285714285714285714285714, 0.310714285714285714285714, -0.289285714285714285714286, -0.00714285714285714285714286, -0.0142857142857142857142857, -0.0214285714285714285714286, -0.0214285714285714285714286, -0.0142857142857142857142857, -0.00714285714285714285714286, 0.0228571428571428571428571, 0.0171428571428571428571429, 0.01731947115335539787, 0.01125195741807317355, 0.00659735576677698939, 0.01625978709036586775, 0.0571428571428571428571429, 0.05125195741807317355, 0.00589089972478396930, -0.00088307005249127511, 0.0685714285714285714285714, 0.0171428571428571428571429], dtype=np.longdouble)
...
##
##                book.save(filename_or_stream='GuGuSymmetric631.xls') # 一定要保存


                data = xlrd.open_workbook('GuGuSymmetric631.xls',formatting_info=True)
                ...
                for value in values:
                    ...
                    col = col+1
                excel.save('GuGuSymmetric631.xls')
...
##			    plt.scatter([PtsU, 1-PtsU, 1-PtsV, 1-PtsV, 1-PtsU, PtsU, PtsV, PtsV], [PtsV, PtsV, PtsU, 1-PtsU, 1-PtsV, 1-PtsV, 1-PtsU, PtsU], s=1e4*np.abs([Wts, Wts, Wts, Wts, Wts, Wts, Wts, Wts]), color=plt.cm.hsv(numConverged/maxConverged), edgecolors='none', alpha=0.5, label=str(numConverged)) # 0.2 # 0.01
                plt.scatter(pointsX, pointsY,
                            ...
                            label=str(numConverged))	#color='tab:blue'
