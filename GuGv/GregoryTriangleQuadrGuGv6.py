...
NUMOFTWOSYMPOINT = 0 #25

# Set the number of 3-fold symmetric points
NUMOFTHREESYMPOINT = 1 #
...
def evalFuncsTwo(uVals, vVals, indsRowCol):
    u, v = uVals, vVals
    ...
    evalsH = np.zeros([2, 15, numOfVals])
    for j in range(15):
        row = np.zeros(numOfVals)
        for k in range(numOfVals):
            row[k] = H(u[k], v[k])[j]
...
# Because I saw the symmetry in the plots of maple
def evalFuncsSix(uVals, vVals, indsRowCol):
    u, v = uVals, vVals
...
def determineSymmetriesProducts():
    ...
    for i in range(15):
        ...
        row = np.zeros([1, 6])
        row[0][0] = ndGdv(P3[0,0], P3[0,1])[i]
        row[0][1] = ndGdv(P3[1,0], P3[1,1])[i]
        row[0][2] = ndGdv(P3[2,0], P3[2,1])[i]
        row[0][3] = ndGdv(P3[3,0], P3[3,1])[i]
        row[0][4] = ndGdv(P3[4,0], P3[4,1])[i]
        row[0][5] = ndGdv(P3[5,0], P3[5,1])[i]
        print("row ", row)
        R4[i] = row
...
def computeExactInts(indsRowCol):
   ...
   #quit()
	...
	# dGdu*dGdv (51)
    return np.array([0., 0.0500000000000000000000000, -0.300000000000000000000000, 0.150000000000000000000000, 0., 0., 0., 0., 0.300000000000000000000000, 0.0642857142857142857142857, -0.0357142857142857142857143, -0.0357142857142857142857143, -0.0857142857142857142857143, -0.128571428571428571428571, 0.171428571428571428571429, -0.0342857142857142857142857, -0.0228571428571428571428571, -0.0228571428571428571428571, -0.0342857142857142857142857, -0.0428571428571428571428571, -0.0428571428571428571428571, 0.112500000000000000000000, -0.144642857142857142857143, -0.0455357142857142857142857, 0.0258928571428571428571429, 0.0366071428571428571428571, -0.0562500000000000000000000, 0.0364285714285714285714286, 0.0278571428571428571428571, 0.0214285714285714285714286, 0.0178571428571428571428571, 0.0207142857142857142857143, 0.0328571428571428571428571, -0.144642857142857142857143, 0.198214285714285714285714, 0.233035714285714285714286, -0.0348214285714285714285714, -0.0776785714285714285714286, -0.0492857142857142857142857, -0.0578571428571428571428571, -0.0471428571428571428571429, -0.0278571428571428571428571, -0.0250000000000000000000000, -0.0357142857142857142857143, -0.0455357142857142857142857, 0.0830357142857142857142857, -0.0776785714285714285714286, -0.0348214285714285714285714, -0.0278571428571428571428571, -0.0471428571428571428571429, -0.0578571428571428571428571, -0.0492857142857142857142857, -0.0357142857142857142857143, -0.0250000000000000000000000, 0.0258928571428571428571429, 0.0937500000000000000000000, 0.0366071428571428571428571, 0.0178571428571428571428571, 0.0214285714285714285714286, 0.0278571428571428571428571, 0.0364285714285714285714286, 0.0328571428571428571428571, 0.0207142857142857142857143, 0.0375000000000000000000000, 0.0875000000000000000000000, 0.00714285714285714285714286, -0.0107142857142857142857143, -0.0192857142857142857142857, -0.0128571428571428571428571, 0.00500000000000000000000000, 0.0164285714285714285714286, 0.0875000000000000000000000, -0.0128571428571428571428571, -0.0192857142857142857142857, -0.0107142857142857142857143, 0.00714285714285714285714286, 0.0164285714285714285714286, 0.00500000000000000000000000, 0.0171428571428571428571429, 0.00857142857142857142857143, 0.00830650755568118889, 0.01169349244431881111, 0.00901296359767420898, 0.00812989354518293388, 0.00857142857142857142857143, 0.0514285714285714285714286, 0.04312206387289023968, -0.00044153502624563755, -0.00241560783089721959, 0.00830650755568118889, 0.04312206387289023968, -0.00241560783089721959, -0.00044153502624563755, 0.01169349244431881111, 0.00812989354518293388, 0.00901296359767420898, 0.00571428571428571428571429, 0.00857142857142857142857143, 0.00857142857142857142857143], dtype=np.longdouble)
...
##
##                book.save(filename_or_stream='GuGvSymmetric631.xls') # 一定要保存

                

                data = xlrd.open_workbook('GuGvSymmetric.xls',formatting_info=True)
